 ...
 */
MNRLBoolean& Gate::toMNRLBool(MNRLDefs::BooleanMode m) {
    MNRLBoolean *b = new MNRLBoolean(
            m,
            (unsigned int)1, // port count
            id,
    ...
    if(eod) {
      b->setReportEnable(MNRLDefs::ReportEnableType::ENABLE_ON_LAST);
    }
    return *b;
}
